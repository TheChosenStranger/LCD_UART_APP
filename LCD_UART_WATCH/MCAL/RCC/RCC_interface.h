...
/*Defining functions*/
u8 RCC_u8SystemClockSelect(u8 source);
u8 RCC_u8EnableClock(u8 source);
u8 RCC_u8DisableClock(u8 source);
u8 RCC_u8BusPrescaler(u8 bus,u16 division);
u8 RCC_u8PLLConfigure(u8 source,u8 division,u8 multiplier);
u8 RCC_u8MCOConfigure(u32 source);
u8 RCC_u8EnablePeripheral(u32 periferal);
u8 RCC_u8DisablePeripheral(u32 periferal);
u8 RCC_u8GetPeripheralFreq(u32 periferal,u32 *local_sysclk);