...
/*Defining LCDs pins*/
#define HLCD_E_PIN		PIN0	
#define HLCD_RS_PIN		PIN1
#define HLCD_RW_PIN		PIN2
#define HLCD_D0_PIN		PIN3
#define HLCD_D1_PIN		PIN4
#define HLCD_D2_PIN		PIN5
#define HLCD_D3_PIN		PIN6
#define HLCD_D4_PIN		PIN7
#define HLCD_D5_PIN		PIN8
#define HLCD_D6_PIN		PIN9
#define HLCD_D7_PIN		PIN10
/*Defining LCDs ports*/
...
/*Defining LCDs mode*/
#define HLCD_PIN_MODE		OUTPUT_PUSHPULL_10MHZ
/*Defining data bits*/
